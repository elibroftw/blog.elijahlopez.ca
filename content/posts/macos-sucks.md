...
A VPN I use, Obscura VPN, has to work with macOS's system network extension, which is a black box that provides the VPN with packets to tunnel. Due to this necessity, when the app was released on Windows and Linux, VPN speeds were faster over a wi-fi connection on a Windows laptop than a 1gbps ethernet connection.
